/**
 * Shared HTML email layout wrapper for all Zawadi transactional emails.
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="background-color:${BRAND_PRIMARY};padding:24px 32px;text-align:center;">
              <span style="font-size:28px;font-weight:800;color:#ffffff;letter-spacing:1px;">Zawadi</span>
            </td>
          </tr>
          <!-- Body -->
          <tr>
